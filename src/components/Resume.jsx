...
import { resumeInfo } from "../Essentials/content";
...
function Resume() {
  const handleDownload = (document) => {
    ...
    link.download = document.downloadUrl.split('/').pop();
    ...
    >
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
          {resumeInfo.documents.map((document, index) => (
            <motion.div
              key={document.id}
            ...
            >
              ...
              >
                <svg 
                  ...
                  viewBox="0 0 24 24"
                >
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={document.icon} />
                </svg>
              </motion.div>
        ...
        >
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-gray-700/50 max-w-2xl mx-auto">
            ...
            >
              ...
              <h4 className="text-lg font-semibold text-white">Need a Custom Format?</h4>
            </motion.div>
            <motion.p 
            ...
            >
              If you need my resume or CV in a different format (Word, plain text, etc.), 
              feel free to <a href="#contact" className="text-blue-400 hover:text-blue-300 transition-colors underline">contact me</a> and I'll be happy to provide it.
            </motion.p>
          </div>
        </motion.div>
      </div>
