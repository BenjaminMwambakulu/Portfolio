    ...
    <section id="contact" className="w-full py-20 relative">
      ...
      <div className="absolute inset-0 overflow-hidden -z-10">
        <div className="filter blur-3xl opacity-20">
          <div className="bg-blue-400 w-40 h-40 rounded-full absolute top-10 left-20 animate-pulse"></div>
          <div className="bg-blue-600 w-32 h-32 rounded-full absolute bottom-20 right-10 animate-bounce"></div>
          <div className="bg-blue-800 w-36 h-36 rounded-full absolute top-1/2 right-1/3"></div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            {/* Social Links */}
            <div>
              <h4 className="text-lg font-mono font-semibold mb-4 text-white">
                Connect With Me
              </h4>
              <div className="flex gap-4">
                {contactInfo.socialLinks.map((social, index) => (
                  <a
                    ...
                    className="w-12 h-12 bg-gray-800/50 backdrop-blur-sm rounded-full flex items-center justify-center border border-gray-700/50 hover:bg-blue-500/20 hover:border-blue-500/50 transition-all group"
                  >
                    <img
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className="w-full px-4 py-3 bg-gray-700/50 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all resize-none"
              ...
              <button
                ...
                className="w-full bg-blue-500 hover:bg-blue-600 disabled:bg-blue-500/50 text-white px-6 py-3 rounded-lg font-semibold transition-all flex items-center justify-center gap-2"
              >
                {isSubmitting ? (
                  <>
