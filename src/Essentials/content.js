...
const projects = [
    {
        ...
        description: "A e-commerce template built with React and TailwindCSS. It is a fully responsive website. Easy to use and customize by using JSON data.",
    ...
    },
    {
        id: 2,
        title: "Pamsika",
        description: "Pamsika is frontend ecommerce app that utilize ReactJS and TailwindCSS. Group assignment utilizing the knowledge from Human Computer Interaction",
        technologies: ["React", "TailwindCSS"],
        image: "pamsika.png",
        liveUrl: "https://example.com",
        live: false,
    ...
    },
    {
        id: 3,
        title: "NotesQuest",
        description: "NotesQuest is a personal note taking app that uses Supabase, React and TailwindCSS. Authentication using Supabase",
...
const resumeInfo = {
    ...
    subtitle: "Get a copy of my resume and CV to learn more about my experience and qualifications.",
    documents: [
        {
            id: 1,
            title: "Resume",
            description: "A concise overview of my skills, experience, and education tailored for quick review.",
            type: "PDF",
            size: "245 KB",
        ...
        },
        {
            ...
            description: "A comprehensive document detailing my complete academic and professional background.",
            type: "PDF",
            size: "387 KB",
            lastUpdated: "January 2025",
            available: false,
